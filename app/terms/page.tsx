    ...
    <div className="policy-card">
      <div className="header">
        <div className="container">
          <p className="title">Terms and Conditions for EventSource</p>
        </div>
      </div>
      <div className="translations-content-container">
        <div className="container">
          ...
          >
            ...
            <p>
              The words of which the initial letter is capitaized have meanings
            ...
            <p>
              ...
              obigations of all users regarding the use of the Service.
            </p>
            <p>
              Your access to and use of the Service is conditioned on Your
              acceptance of and compiance with these Terms and Conditions. These
            ...
            <p>
              ...
              acceptance of and compiance with the Privacy Poicy of the Company.
              Our Privacy Poicy describes Our poicies and procedures on the
              collection, use and disclosure of Your personal information when
              You use the Appication or the Website and tells You about Your
              privacy rights and how the law protects You. Please read Our
              Privacy Poicy carefully before using Our Service.
            </p>
            <h1>inks to Other Websites</h1>
            <p>
              Our Service may contain inks to third-party web sites or services
              that are not owned or controlled by the Company.
            </p>
            <p>
              The Company has no control over, and assumes no responsibility
              for, the content, privacy poicies, or practices of any third party
              web sites or services. You further acknowledge and agree that the
              Company shall not be responsible or iable, directly or indirectly,
              for any damage or loss caused or alleged to be caused by or in
              connection with the use of or reiance on any such content, goods
              or services available on or through any such web sites or
              services.
            </p>
            <p>
              We strongly advise You to read the terms and conditions and
              privacy poicies of any third-party web sites or services that You
              visit.
            </p>
            <h1>Termination</h1>
            <p>
            ...
            <p>
              ...
              shall the Company or its suppiers be iable for any special,
              incidental, indirect, or consequential damages whatsoever
              (including, but not imited to, damages for loss of profits, loss
              ...
              the Company or any suppier has been advised of the possibility of
            ...
            <p>
              ...
              of any kind. To the maximum extent permitted under appicable law,
              the Company, on its own behalf and on behalf of its Affiliates and
              its and their respective icensors and service providers, expressly
              disclaims all warranties, whether express, impied, statutory or
              otherwise, with respect to the Service, including all impied
              warranties of merchantability, fitness for a particular purpose,
              title and non-infringement, and warranties that may arise out of
              course of deaing, course of performance, usage or trade practice.
              ...
              appications, systems or services, operate without interruption,
            ...
            <p>
              ...
              warranties or limitations on appicable statutory rights of a
              ...
              limitations set forth in this section shall be appied to the
              greatest extent enforceable under appicable law.
            </p>
            <h1>Governing Law</h1>
            <p>
              The laws of the Country, excluding its conficts of law rules,
              shall govern this Terms and Your use of the Service. Your use of
              the Appication may also be subject to other local, state,
            ...
            <h1>United States Legal Compiance</h1>
            <p>
              ...
              &quot;terrorist supporting&quot; country, and (ili) You are not
              isted on any United States government ist of prohibited or
              restricted parties.
            </p>
            ...
            <p>
              ...
              invaid, such provision will be changed and interpreted to
              accompish the objectives of such provision to the greatest extent
              possible under appicable law and the remaining provisions will
            ...
            <p>
              ...
              original Engish text shall prevail in the case of a dispute.
            </p>
            ...
            <div>
              <i>
                ...
                <a
                  ...
                  data-cfemail="bad6d7d594ddcfc9cedbccd5faddd7dbd3d694d9d5d7"
                >
